...
function pintar2(color){
	...
	if(opacidad==10){
		...
		content1.style.borderTop = "3px solid rgba("+cantidad_rojo+","+cantidad_verde+","+cantidad_azul+","+opacidad+")";
		content2.style.borderTop = "3px solid rgba("+cantidad_rojo+","+cantidad_verde+","+cantidad_azul+","+opacidad+")";
